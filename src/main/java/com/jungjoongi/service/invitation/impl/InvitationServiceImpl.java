package com.jungjoongi.service.invitation.impl;
...
@Service
public class InvitationServiceImpl implements EstimateService {

	EstimateDao estimateDao;
	
	InvitationServiceImpl(EstimateDao estimateDao) {
